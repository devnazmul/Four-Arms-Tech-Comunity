  ...
  ">
    ...
    <div class="flex justify-center lg:block lg:w-full xl:px-20 lg:px-5 lg:mr-5">
        ...
        ">
            ...
            <form id="signup_from" class="my-5 w-full flex justify-center items-center flex-col lg:block" action="#"
              ...
              items-center
            " for="profile_pic">
                        <img class="object-cover rounded-full w-full h-full" id="output" src='./assets/img/upload.png'
                            for="profile_pic" />
                    </label>
                    <input onchange="loadFile(event)" name="profile_pic" id="profile_pic" type="file"
