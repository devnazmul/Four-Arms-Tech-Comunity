...
--
-- Host: localhost
-- Generation Time: Jul 26, 2021 at 07:08 PM
...
CREATE TABLE `messages` (
  ...
  `incomming_sms_id` int(255) NOT NULL,
  `outgoing_sms_id` int(255) NOT NULL,
  `sms` varchar(1000) COLLATE utf8_unicode_ci NOT NULL,
  `sms_file` varchar(255) COLLATE utf8_unicode_ci NOT NULL
