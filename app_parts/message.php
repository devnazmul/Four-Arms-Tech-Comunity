...
?>
    <div class="overflow-hidden message w-full hidden sm:block">
        ...
        <!-- SMS Area  -->
        <div id="smsArea" class="overflow-y-scroll sm:px-5 px-10 conversation">
        </div>
        ...
        <form autocomplete="off" action="#" class="sms_form w-full mt-2 mb-4 rounded sm:px-1 px-8 pt-1 flex items-center">
            ...
            <input name="sms" id="sms_input" placeholder="Type your message" class="sms_input shadow-md outline-none w-full pr-10 bg-black rounded-full text-gray-600 ml-5 px-3 py-2" type="textarea">
